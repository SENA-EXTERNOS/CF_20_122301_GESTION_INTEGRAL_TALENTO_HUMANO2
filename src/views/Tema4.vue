  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5.bf-t4
          ...
          .col-sm-6.col-lg-6.mb-4.mb-lg-0
            .t3.tarjeta-avatar
              ...
              .tarjeta.tarjeta--amarilla-1.p-5
                p.text-center.mt-5 El #[em software] libre no tiene #[i copyright]. No tiene que ser gratis y el usuario tiene libertad sobre para usarlo, copiarlo, modificarlo y distribuirlo como lo desee. Esto permite a miles de desarrolladores, ampliar sus posibilidades y expandir su conocimiento.

          .col-sm-6.col-lg-6.mb-4.mb-lg-0
            .t3.tarjeta-avatar
              img(src='@/assets/curso/temas/tema4/t4-3.svg' alt='AvatarTop')
              .tarjeta.tarjeta--amarilla-1.p-5
                p.text-center.mt-5 El #[em software] de propietario, es aquel al que su creador lo limita o prohíbe copiar, redistribuir y modificar sin su permiso o sin un pago previo.
    ...
    .row.justify-content-center.bkg-t4
        ...
        .col-lg-10
          .bloque-texto-g.color-primario.p-3.p-sm-4.p-md-5
            ...
            .b4.bloque-texto-g__texto.p-4
              p.mb-0 También, aparte de estos dos tipos de licencias, se cuenta con el #[i software] gratuito o de dominio público, que no tiene #[i copyright] y se puede utilizar, aunque el autor puede poner restricciones para redistribuir el programa y los trabajos que se deriven de él. En otro orden de ideas, existe la licencia de #[em software] semi libre, es decir, que tiene propietario, pero el programa viene con autorización para usar, copiar, distribuir y modificar si se es un particular y se carece de ánimo de lucro.
      ...
      .row.justify-content-start.align-items-center.mt-3
        .col-lg-4
          .color-degrade.p-1(data-aos="fade-right")
            h4(data-aos="fade-down").mb-0 #[em Software] comercial
      ...
      .row.justify-content-center.mt-5
        ...
        .col-lg-10
          ...
          .row.mt-4
            .col-lg-10
              h4.mb-4 Tipo de licencias para los #[em software] comerciales
              .cajon.color-1.p-4.mb-3
                p.mt-0 Hay que analizar si el #[em software] es:
                ul.lista-ul.mt-3
                  li
